...
This handbook covers **183 source files** across **11 modules**. Browse by module below, or jump to the flat [file Index](Index.md).
...
| --- | --- | --- |
| [Magnetar.Protocol](Modules/Magnetar.Protocol.md) | 28 | Shared wire/discovery contracts and release/runtime helpers between agent and supervisor. |
