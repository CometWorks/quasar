...
| Export | Purpose |
|---|---|
| `state` | Singleton object holding renderer/scene/camera references, groups, controls, loaded-scene metadata including voxel/context support and floor-grid alignment, selected asset folders, active mod roots, cache maps, texture stats, timing counters, and UI stats. |
