...
## Summary
Standalone styling for the grid viewer page. It defines the dark sci-fi layout, sidebar control cards, stats/log presentation, full-window Three.js viewport, hover/camera overlays, and mobile stacking behavior.
...
- `.log-card pre`, `.hover-readout`, and `.camera-hint` style diagnostics and viewport overlays.
