...
- `QuasarConfigMetadata` (static class):
  - `Categories` — read-only list of 11 `QuasarConfigOptionCategory` objects
  - `Options` — read-only list of ~120 `QuasarConfigOptionDefinition` objects spanning Root and Session scopes
