...
- **Key UI sections:**
  ...
  - `MudTable<EntitySummary>` — columns show Delete action, Type, Entity ID, Sub-type, Blocks, PCU, Size (m), Owner, Position, and Name; sortable by Name, Blocks, PCU, Size; pager (25/50/100/250 options); fixed header at 60 vh.
