    ...
    ISnackbar snackbar)
{
    ...
    private DedicatedServerDefinition CreateBlank()
    {
        ...
        return new DedicatedServerDefinition
        {
            ...
            AgentStartupGraceSeconds = DedicatedServerDefinition.DefaultAgentStartupGraceSeconds,
            AgentStartupHardLimitSeconds = DedicatedServerDefinition.DefaultAgentStartupHardLimitSeconds,
